        ...
        <div className="tabs_body">
          ...
          <div id="tab02" className="tabs_block">
            <div className="tab_details">
              <div className="city">{isResult?isResult.name:'---'}</div>
              <div>
                <p className="temperatureTab2">Temperature: {
                    isResult?Math.round(isResult.main.temp):'---°'} </p>
                <p className="feelsLikeForm2">Feels like: {
                    isResult?Math.round(isResult.main.feels_like):'---°'} </p>
                <p className="weatherForm2">Weather: {
                    isResult?(isResult.weather[0].main):'---°'} </p>
                <p className="sunriseForm2">Sunrise: {
                    isResult?(toHumanDate(isResult.sys.sunrise)):'---°'}</p>
                <p className="sunsetForm2">Sunset: {
                    isResult?(toHumanDate(isResult.sys.sunset)):'---°'}</p>
              </div>
            </div>
          </div>
